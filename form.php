		...
		<div class="span12 text-center">
			...
			<div class="row-fluid bg-w">
				...
				<div class="span12">
					...
					<p style="margin-bottom:100px;">Suiza está muy cerca, sólo debes comprar Toddy pa’ la leche en supermercados Jumbo, llenar este formulario y ya estarás  participando por un viaje para 2 personas!</p>
