			...
			<div class="span12 text-center">
				...
				<div class="row-fluid bg-w">
					<div class="span12">
						...
						<p>Suiza está muy cerca, sólo debes comprar Toddy pa’ la leche en supermercados Jumbo, llenar este formulario y ya estarás  participando por un viaje para 2 personas!</p>
						
						<div class="baca">
							
							<img src="images/baca_toddy.gif" alt="Toddy">

						</div>
						
						<div class="row-fluid cont-form">
										...
										<div class="row-fluid">
											...
											<div class="span4">
												...
												<div class="control-group">
													...
													<label class="contrl-label" for="inputCelular">celular</label>
													<div class="controls">
